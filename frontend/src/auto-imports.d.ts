...
declare global {
  ...
  const useRedisServersStore: typeof import('./stores/redisServers').useRedisServersStore
...
declare module 'vue' {
  ...
  interface ComponentCustomProperties {
    ...
    readonly useRedisServersStore: UnwrapRef<typeof import('./stores/redisServers')['useRedisServersStore']>

---
description: "DDD and .NET architecture guidelines. Use it when designing or implementing c# code. Follow the mandatory thinking process and quality checklist before delivering any code."
